...
import numpy as np
from transducer_tensorflow import transducer
...
class TransduerTest(tf.test.TestCase):

    def _run_transducer(self, activations, input_lengths,
        ...
        costs = transducer(activations=activations_t,
